      ...
      <section className="py-24 bg-[#EAF5F0]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">Какво е Втори Шанс?</h2>
            <p className="text-lg text-slate-600">
              Втори Шанс е първоначална оценка, която ти помага да разбереш къде стоиш, какви са реалните ти опции и коя е следващата разумна стъпка.
            </p>
          </div>
          ...
          <div className="max-w-[1100px] mx-auto">
            <div className="w-full mb-[40px]">
              <img 
                src="/content/diagnostic3.png" 
                alt="Трите етапа на Втори Шанс" 
            ...
            <form className="space-y-6" action="https://api.web3forms.com/submit" method="POST">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" name="name" required className="w-full p-3 rounded-lg border-2 border-slate-200 bg-white text-[14px] text-slate-900 outline-none focus:border-teal-500" />
                </div>
                <div>
                  <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">Имейл</label>
                  <input type="email" name="email" required className="w-full p-3 rounded-lg border-2 border-slate-200 bg-white text-[14px] text-slate-900 outline-none focus:border-teal-500" />
                </div>
              </div>

              <div>
                <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">Телефон</label>
                <input type="tel" name="phone" required className="w-full p-3 rounded-lg border-2 border-slate-200 bg-white text-[14px] text-slate-900 outline-none focus:border-teal-500" />
              </div>

              <div>
                <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">Viber / WhatsApp (ако е различен)</label>
                <input type="tel" name="viber_whatsapp" className="w-full p-3 rounded-lg border-2 border-slate-200 bg-white text-[14px] text-slate-900 outline-none focus:border-teal-500" />
              </div>
              
              <div>
                <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">Къде живееш в момента?</label>
                <input type="text" name="location" required placeholder="напр. Германия, Великобритания, България" className="w-full p-3 rounded-lg border-2 border-slate-200 bg-white text-[14px] text-slate-900 outline-none focus:border-teal-500" />
              </div>

              <div className="space-y-4 pt-6 border-t border-slate-100">
                <label className="flex items-start gap-3 cursor-pointer">
                  <input type="checkbox" name="wants_to_return" value="yes" className="mt-1 w-4 h-4 text-teal-600 rounded border-slate-300 focus:ring-teal-500" />
                  <span className="text-slate-700 text-[14px] font-medium">Искам да се върна в България</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer">
                  <input type="checkbox" name="has_debts" value="yes" className="mt-1 w-4 h-4 text-teal-600 rounded border-slate-300 focus:ring-teal-500" />
                  <span className="text-slate-700 text-[14px] font-medium">Имам стари кредити или задължения</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer">
                  <input type="checkbox" name="has_bailiff" value="yes" className="mt-1 w-4 h-4 text-teal-600 rounded border-slate-300 focus:ring-teal-500" />
                  <span className="text-slate-700 text-[14px] font-medium">Имам информация за ЧСИ, запор или дело</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer">
                  <input type="checkbox" name="interests_in_business" value="yes" className="mt-1 w-4 h-4 text-teal-600 rounded border-slate-300 focus:ring-teal-500" />
              ...
              <div className="pt-6 border-t border-slate-100">
                ...
                <input type="text" name="estimated_debt" className="w-full p-3 rounded-lg border-2 border-slate-200 bg-white text-[14px] text-slate-900 outline-none focus:border-teal-500" />
              </div>

               <div className="pt-4">
                <label className="block text-[12px] font-semibold text-slate-600 mb-1.5">Какво те притеснява най-много? (Опиши накратко)</label>
                <textarea rows={4} name="message" required className="w-full p-4 rounded-lg border-2 border-slate-200 bg-white text-[14px] text-slate-900 outline-none focus:border-teal-500 resize-none"></textarea>
              </div>
